...
namespace Managing_coffee_shop.Module;

// For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
public sealed class Managing_coffee_shopModule : ModuleBase {
    public Managing_coffee_shopModule() {
		// 
		// Managing_coffee_shopModule
		// 
